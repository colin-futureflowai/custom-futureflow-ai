...
interface WorkshopLandingClientProps {
  pageData: any
  selectedVariant: string
}

export default function WorkshopLandingClient({ pageData, selectedVariant }: WorkshopLandingClientProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#3D3D3D] mb-4">
              Workshop Materiaal Preview
            </h2>
            <p className="text-xl text-gray-600">
              Bekijk het hoogwaardige lesmateriaal dat u ontvangt tijdens de workshop
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-lg mb-2">{pageData.sharedContent.workshopTitle}</h3>
              <p className="text-gray-600">Intensieve 1-daagse training</p>
            </div>
            <div className="text-center">
              <div className="bg-[#32a029]/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">✨</span>
              ...
              <p className="text-gray-600">{pageData.sharedContent.trainer}</p>
            </div>
            <div className="text-center">
              <div className="bg-[#32a029]/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🚀</span>
              </div>
              <h3 className="font-semibold text-lg mb-2">Direct Toepasbaar</h3>
              <p className="text-gray-600">Start vandaag met AI</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm max-w-md mx-auto">
            <div className="text-2xl font-bold mb-2 text-[#3D3D3D]">Workshop early bird prijs</div>
